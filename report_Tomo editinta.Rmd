...
rel_rusoil <- rel_rusoil %>% 
  mutate(`Total Oil Imports from Russia / Total Oil Imports (%)` = gsub("%", "", `Total Oil Imports from Russia / Total Oil Imports (%)`)) %>% 
  select(Date, Country, `Total Oil Imports from Russia / Total Oil Imports (%)`)
...
In context of white noise, in the case of the additive_ets model and auto_crude_ets, the significant values at lag 12 and lag 15 respectively suggest that there is some correlation or pattern present in the residuals at those specific lags.

...
```{r, data_prep, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray'}
library(fpp3)
library(tidyverse)
library(ggplot2)
library(dplyr)

...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Times series overivew-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/overview by product-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Seasonal plot for each product-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Seasonal plot for each product-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Seasonal plot for each product-3} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/seasonal-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/seasonal-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/seasonal-3} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Acf and white noise-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Acf and white noise-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Acf and white noise-3} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Plotting components-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Plotting components-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Plotting components-3} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Forecasting plots-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Forecasting plots-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Residual diagnostics (crude oil)-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Residual diagnostics (crude oil)-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Residual diagnostics (nat gas)-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Residual diagnostics (nat gas)-2} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/setup ETS-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Determing ETS model for Crude Oil exports-1} \end{center}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/applying ETS()-1} \end{center}
...
\includegraphics{report_Tomo-editinta_files/figure-latex/Overview of Reliance of OECD Europe on RUssian Crude Oil-1.pdf}
...
\includegraphics{report_Tomo-editinta_files/figure-latex/Overview of Reliance of OECD Europe on RUssian Crude Oil-2.pdf}
...
\includegraphics{report_Tomo-editinta_files/figure-latex/Forecast for reliance-1.pdf}
...
\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Checking residual of ETS models-1} \end{center}

\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Checking residual of ETS models-2} \end{center}

\begin{center}\includegraphics{report_Tomo-editinta_files/figure-latex/Checking residual of ETS models-3} \end{center}
...
\includegraphics{report_Tomo-editinta_files/figure-latex/Unit root test-1.pdf}
...
\includegraphics{report_Tomo-editinta_files/figure-latex/first order difference-1.pdf}
...
\includegraphics{report_Tomo-editinta_files/figure-latex/unnamed-chunk-1-1.pdf}

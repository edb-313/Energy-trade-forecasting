...
#### 4.1. Exploring different simple forecasting methods

Before moving forward with forecasting using simple forecasting methods we take a look at both time series and what simple forecasting methods works best with both

```{r, evaluating models,echo=FALSE, results='markup',warning=FALSE,message=FALSE  }
...
We begin with evaluating each method performance on given time series using function accuracy() and then plot each method against train data to see visually see how each method performs. 

...
oecd_crude_oil_agg <- box_cox(oecd_crude_oil_agg$`Amount of Crude Oil (Thousand Barrels)`, 0.28)

oecd_oil_prod_agg %>% features(`Amount of total Petroleum Porducts (Thousand Barrels)`, features = guerrero)
oecd_oil_prod_agg  <- box_cox(oecd_oil_prod_agg$`Amount of total Petroleum Porducts (Thousand Barrels)`, 0.907)

oecd_nat_gas_agg %>% features(oecd_nat_gas_agg$`Amount of Natural gas (BOE)`, features = guerrero)
oecd_nat_gas_agg <- box_cox(oecd_nat_gas_agg$`Amount of Natural gas (MMcf)`, 1.13)

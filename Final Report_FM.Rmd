...
```{r setup ETS, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray'}
...
```{r  comparison of ETS models, echo=FALSE}
...
```{r  Overview of Reliance of OECD Europe on RUssian Crude Oil, echo=FALSE}
...
**Komentaras apie bendra triju eksportu ir priklausomybes tendencija**

5.3 Checking the residuals

```{r Checking residual of ETS models, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}
#Plotting Residual
...
```{r Comparison of ETS model against simple models, echo=FALSE}
...
```{r, Unit root test, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}
...
```{r, first order difference,echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}
...
```{r stationarity, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}
...
```
```{r, ARIMA estimation, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}

# Estimate ARIMA models
model_1 <- arima(crude_oil_bx$diff_total_exports, order = c(1, 0, 0))
model_2 <- arima(crude_oil_bx$diff_total_exports, order = c(0, 0, 1))
model_3 <- arima(crude_oil_bx$diff_total_exports, order = c(1, 0, 1))
...
```{r, comparison of ARIMA,echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}
...
```{r, prophet, echo=FALSE, results='markup',warning=FALSE,message=FALSE, fig.align='center', background= 'gray',echo=FALSE}
library(fable.prophet)


train_pr <- crude_oil_bx %>%
